...
REM
REM Generated by Vivado on Mon Dec 29 00:00:17 +0800 2025
...
echo "xvlog --incr --relax -L uvm -prj xor4_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj xor4_tb_vlog.prj -log xvlog.log
