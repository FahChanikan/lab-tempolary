...
REM
REM Generated by Vivado on Sun Dec 28 00:40:17 +0800 2025
...
echo "xvlog --incr --relax -L uvm -prj alu_simple_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj alu_simple_tb_vlog.prj -log xvlog.log
