...
REM
REM Generated by Vivado on Wed Dec 31 00:07:38 +0800 2025
...
echo "xvlog --incr --relax -L uvm -prj decorder_2to4_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj decorder_2to4_tb_vlog.prj -log xvlog.log
