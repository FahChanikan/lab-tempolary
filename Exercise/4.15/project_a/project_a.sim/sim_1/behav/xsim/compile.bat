...
REM
REM Generated by Vivado on Wed Dec 31 00:33:45 +0800 2025
...
echo "xvlog --incr --relax -L uvm -prj boolean_a_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj boolean_a_tb_vlog.prj -log xvlog.log
